...
class BahdanauAttentionAudio(nn.Module):
    ...
    def __init__(self, units, hidden_size):
        ...
        self.loc_conv = nn.Conv1d(in_channels=198, out_channels=198, kernel_size=2*self.kernel_size+1,
                                  padding=self.kernel_size, bias=False)
...
class SuperHeadAttention(nn.Module):
    ...
    def __init__(self, units, hidden_size):
        ...
        self.attention_2 = LuongAttentionGeneral(hidden_size=hidden_size)
        self.attention_3 = LuongAttentionConcat(units=units, hidden_size=hidden_size)
